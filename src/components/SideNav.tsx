  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-20 z-40 bg-surface-container-low shadow-[0_0_30px_rgba(199,125,255,0.1)] hidden lg:flex flex-col items-center py-10 pt-28">
      ...
      <div className="flex flex-col items-center space-y-8 flex-1">
        <a className="p-3 text-primary hover:bg-surface-container-high hover:text-on-surface rounded-full transition-transform duration-500 ease-in-out" href="https://github.com/Edric2412" target="_blank" rel="noopener noreferrer" title="GitHub">
          <Github className="w-6 h-6" />
        </a>
        <a className="p-3 text-primary hover:bg-surface-container-high hover:text-on-surface rounded-full transition-transform duration-500 ease-in-out" href="https://www.linkedin.com/in/edric-jeffrey-sam-52502927b/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
          <Linkedin className="w-6 h-6" />
        </a>
        <a className="p-3 text-primary hover:bg-surface-container-high hover:text-on-surface rounded-full transition-transform duration-500 ease-in-out" href="https://huggingface.co/Edric2412" target="_blank" rel="noopener noreferrer" title="Hugging Face">
